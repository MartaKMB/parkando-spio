        ...
        return (
            <section className="choice-page-container">
                ...
                {/* TODO! */}
                    ...
                    <input className="map-details__btn-place btn-place btn-place--8" type="button" value="8" id={8} onClick={this.handleClick}></input>
                    <input className="map-details__btn-place btn-place btn-place--9" type="button" value="9" id={9} onClick={this.handleClick}></input>
                    <input className="map-details__btn-place btn-place btn-place--10" type="button" value="10" id={10} onClick={this.handleClick}></input>
                </div>
            </section>
        )
    }
